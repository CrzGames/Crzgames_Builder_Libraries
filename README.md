...
| **NATS Client C (windows-x64)** | v3.12.0 |
...
### ONNX Runtime
#### iOS / macOS :
- macOS 10.12 et ultérieures (c'est écrit sur la doc mais c'est faux) -> Il faut target la version macOS >= 14.0 et avec un sdk >= 14.4.
...
- macOS: Depuis onnxruntime >= 1.22.0, macOS x86_64 Intel ne peux pas plus être pris en charge, seulement Apple Silicon arm64.
